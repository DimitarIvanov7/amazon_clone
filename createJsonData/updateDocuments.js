...
const upDataAll = async () => {
	...
	const prices = findProducts.map((product) => {
		if (product.Data.buybox_winner.new_offers_from)
			return product.Data.buybox_winner.new_offers_from.value;
		else if (product.Data.buybox_winner.mixed_offers_from)
			return product.Data.buybox_winner.mixed_offers_from.value;
		else if (product.Data.buybox_winner.price)
			return product.Data.buybox_winner.price.value;
		return 24.99;
	});
