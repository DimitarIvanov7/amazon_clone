  ...
  return (
    <CategoryContainer id="Categories-and-products">
        ...
        <SpecificItemsContainer>
            ...
            <SpecificItem message={"Top Sellers in Baby Products for you"} item={products[4][0]} />
        ...
        <HomepageSlickSlider title={"Check out supplies for your pet"} itemsShow={6} products={products.length > 0 && products[5]} />
            ...
            <SpecificItemsContainer>
                ...
                <SpecificItem message={"Top Sellers in Software for you"} item={products[6][1]} />
            
                <SpecificItem item={products[5][4]} />

                <SpecificItem message={"Amazon bestseller book"} item={products[7][5]} />
