...
function HeroSlider() {
    ...
    <SliderContainer id='hero-slider'>
        <ButtonSliderLeft onClick={() => handleSlider("prev")}><IoIosArrowBack/></ButtonSliderLeft>
        <ButtonSliderRight onClick={() => handleSlider("next")}><IoIosArrowForward /></ButtonSliderRight>
